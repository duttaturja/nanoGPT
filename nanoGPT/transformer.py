...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type):
        ...
        config_args = {
            'gpt2': dict(n_layer=12, n_head=12, n_embd=768, block_size=768), # 124M params
            'gpt2-medium': dict(n_layer=24, n_head=16, n_embd=1024, block_size=1024), # 355M params
            'gpt2-large': dict(n_layer=36, n_head=20, n_embd=1280, block_size=1280), # 774M params
            'gpt2-xl': dict(n_layer=48, n_head=25, n_embd=1600, block_size=1600), # 1558M params
        }[model_type]
